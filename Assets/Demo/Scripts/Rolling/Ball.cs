...
namespace InputSamples.Demo.Rolling
{
    ...
    public class Ball : MonoBehaviour
    {
        ...
        protected virtual void FixedUpdate()
        {
            ...
            {
                Vector3 brakeForce = -cachedRigidbody.linearVelocity.normalized * brakeAcceleration;
            ...
            if (moving)
            {
                cachedRigidbody.linearDamping = grounded ? groundDragMoving : airDrag;
            }
            else
            {
                cachedRigidbody.linearDamping = grounded ? lastTouchedFriction : airDrag;
            }
            ...
            if (debugLabel != null)
            {
                ...
                builder.AppendFormat("Velocity: {0}, m: {1}", cachedRigidbody.linearVelocity,
                    cachedRigidbody.linearVelocity.magnitude);
                builder.AppendLine();
